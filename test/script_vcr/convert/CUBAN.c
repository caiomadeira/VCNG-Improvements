				...
				if (skip == 0)
				{
					while (TRUE)
					{
						...
						if ((tnt1 == 2) && (tnt2 == 2) && (tnt3 == 2))
						{
							...
							//TASK_GO_STRAIGHT_TO_COORD(ped1, -694.352, 567.472, 12.1556, 3, -2);// пед бежит
							//TASK_GO_STRAIGHT_TO_COORD(ped2, -694.352, 567.472, 12.1556, 3, -2);// пед бежит
							//TASK_GO_STRAIGHT_TO_COORD(ped3, -694.352, 567.472, 12.1556, 3, -2);// пед бежит
							//TASK_GO_STRAIGHT_TO_COORD(ped4, -694.352, 567.472, 12.1556, 3, -2);// пед бежит
							//TASK_GO_STRAIGHT_TO_COORD(ped5, -694.352, 567.472, 12.1556, 3, -2);// пед бежит
