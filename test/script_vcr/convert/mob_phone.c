...
void SetSpeech(void)
{
	...
	while(true)
	{
		...
		else if ((IS_CHAR_IN_WATER(GetPlayerPed())) || (IS_CHAR_DEAD(GetPlayerPed())) || (HAS_CHAR_BEEN_ARRESTED(GetPlayerPed())))//���� ����� ���� ��� ����������
		{
			call_drop = 1;
...
void melodi(void)
{
	...
	START_CUSTOM_MOBILE_PHONE_RINGING( 14 ); // 14 - "SOLO" �� \audio\sfx\general.rpf\GENERAL\MUSIC_RINGTONES
	...
	while(true)
	{
		...
		if ((IS_BUTTON_PRESSED( 0, 16 )) || ((IS_CONTROL_PRESSED( 2, 181 )) && (! IS_USING_CONTROLLER()))) //���������� ENTER
		{
			// ������������� ��������������� ������
		...
		else if ((TIMERA() > 15000) || (IS_CHAR_IN_WATER(GetPlayerPed())) || (IS_CHAR_DEAD(GetPlayerPed())) || (HAS_CHAR_BEEN_ARRESTED(GetPlayerPed())))// ������� ����� ����/���������
		{
			// ������������� ��������������� ������
			STOP_MOBILE_PHONE_RINGING();
			CLEAR_HELP(); // ������� ����� ���������
...
void launcher(void)
{
	...
	{
		WAIT(0);
		if ((G_ONMISSION == 0) && (G_MAIN_CALL == 1)) // ���� ������ "����� � ��������" ��������
		{
			SetTime(8000);
		...
		else if ((G_LAWYER >= 4) && (G_ONMISSION == 0) && (G_MAIN_CALL == 2)) // ���� ������ "���� ���������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_LAWYER >= 4) && (G_ONMISSION == 0) && (G_ASSASSIN == 0)) // ���� ������ "���� ���������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_LAWYER >= 5) && (G_ONMISSION == 0) && (G_CORTEZ == 0))  // ���� ������ "����������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_CORTEZ == 4) && (G_ONMISSION == 0) && (G_DIAZ == 0))  // ���� ������ "����� ���������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_DIAZ >= 3) && (G_ONMISSION == 0) && (G_CORTEZ == 4))  // ���� ������ "��� ���� 86" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_DIAZ >= 3) && (G_ONMISSION == 0) && (G_AVERY == 3))  // ���� ������ "��� ���� 86" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_DIAZ == 6) && (G_CORTEZ == 6) && (G_ONMISSION == 0))  // ���� ������ "����� � �����������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_DIAZ >= 8) && (G_ONMISSION == 0) && (G_CORTEZ == 6))  // ���� ������ "������ ����������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_DIAZ >= 9) && (G_ONMISSION == 0) && (G_ROCK == 0))  // ���� ������ "���������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_DIAZ >= 9) && (G_ONMISSION == 0) && (G_MAIN_CALL == 3))  // ���� ������ "���������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_PROTECT >= 2) && (G_ONMISSION == 0) && (G_AVERY_CALL == 0))  // ���� ������ "�������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_PROTECT >= 3) && (G_ONMISSION == 0) && (G_LANCE_CALL == 0))  // ���� ������ "�������� � ����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_PROTECT >= 4) && (G_ONMISSION == 0) && (G_LANCE_CALL == 1))  // ���� ������ "����� �����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_COUNT >= 2) && (G_ONMISSION == 0) && (G_MAIN_CALL == 4))  // ���� ������ "������� �����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_AVERY >= 5) && (G_ONMISSION == 0) && (G_CUBAN == 0))  // ���� ������ "�� �� ���" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_CUBAN >= 2) && (G_ONMISSION == 0) && (G_HAITI == 0))  // ���� ������ "����� �� �����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_HAITI >= 4) && (G_ONMISSION == 0) && (G_CUBAN == 4))  // ���� ������ "������� ����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_HAITI == 5) && (G_ONMISSION == 0) && (IS_CHAR_IN_AREA_3D( GetPlayerPed(), -209.925, 216.375, -35.491, -917.502, 952.896, 150.0, 0 )))  // ���� ������ "������� ����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_ASSASSIN == 4) && (G_ONMISSION == 0)) // ���� ������ "���������� ����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_ASSASSIN == 6) && (G_ONMISSION == 0) && (G_DIAZ >= 8)) // ���� ������ "�������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_ASSASSIN == 8) && (G_ONMISSION == 0) && (G_DIAZ >= 9)) // ���� ������ "������ �� ��������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_ROCK >= 2) && (G_ONMISSION == 0) && (G_BIKE == 0)) // ���� ������ "��� �����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_BIKE >= 4) && (G_ONMISSION == 0) && (G_ROCK == 3)) // ���� ������ "��������� �� �����" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_ROCK == 5) && (G_ONMISSION == 0) && (G_BIKE == 5)) // ���� ������ "��������� ���" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_CLUB == 6) && (G_ONMISSION == 0) && (G_PHIL == 0)) // ���� ������ "��������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_CLUB == 6) && (G_ONMISSION == 0) && (G_MAIN_CALL == 5)) // ���� ������ "��������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_PRON == 6) && (G_ONMISSION == 0)) // ���� ������ "G - ���������" ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_ONMISSION == 0) && (G_CORTEZ >= 8) && (G_MAIN_CALL == 6) && (G_COUNT == 3) && (G_COKERUN == 2) && (G_BUSINES_SA >= 2) && (G_ICECREAM == 2) && (G_CABS == 4) && (G_PRON >= 5) && (G_CLUB >= 6)) // ���� ��� ������ ������������ ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		if ((G_COUNT == 7) && (G_ONMISSION == 0) && (G_MAIN_CALL == 6)) // ���� ������ "������� ������ �����..." ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_COUNT == 7) && (G_ONMISSION == 0) && (G_MAIN_CALL == 7)) // ���� ������ "������� ������ �����..." ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_COUNT == 7) && (G_ONMISSION == 0) && (G_MAIN_CALL == 8)) // ���� ������ "������� ������ �����..." ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
		...
		else if ((G_COUNT == 7) && (G_ONMISSION == 0) && (G_MAIN_CALL == 9)) // ���� ������ "������� ������ �����..." ��������
		{
			SetTime(8000);
			if ((G_ONMISSION == 0) && (!IS_CHAR_IN_WATER(GetPlayerPed())))
			{
